...
TODO: convert this function to a kernel
...
int main(int argc, char *argv[]) {
    ...
    // allocation
    TODO: allocate u and uNew with cudaMallocManaged
    ...
    TODO: define gridSize and blockSize
